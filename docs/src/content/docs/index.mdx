...
description: Give your AI agent up-to-date knowledge of the complete Microsoft Graph API. Search 27,700 Graph APIs and curated samples — all locally, in milliseconds. Authenticate and call the Microsoft Graph API directly when needed.
template: splash
hero:
  tagline: Bridge the gap between your LLM's training cutoff and the latest Microsoft Graph API. Search 27,700 Graph APIs and curated samples — all locally, in milliseconds. Authenticate and call the Microsoft Graph API directly when needed.
  actions:
    - text: Get Started
